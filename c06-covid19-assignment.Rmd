...
filename <- "./data/ACSDP5Y2018.DP05_data_with_overlays_2020-07-26T080241.csv"
...
df_normalized <-
  df_data %>%
  mutate(
    cases_perk = cases / 100000,
    deaths_perk = deaths / 100000
  )
