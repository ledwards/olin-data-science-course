...
- Price seems to increase as carat increases, although there is quite a range of prices for a given carat. For example, there are diamonds at carats 1 through 5 that are priced near the max price, but the lower price ranges disappear as carats increase. There is a positive relationship between carat and price, but it seems the variance is high.
...
- There is a positive correlation between carat and price, and we can now see the reason for the high variance in price for a given carat, which seems to be that many fair cut diamonds are lower in price, and many ideal and premium cut diamonds are worth more. However, there are a number of outliers - fair cut dimaonds that are at the top price point for their carat.
